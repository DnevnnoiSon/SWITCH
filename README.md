<h1 style="font-size: 28px; color: #2c3e50; text-align: center;">
    🟢 ПО ДЛЯ ИЗМЕРИТЕЛЬНЫХ ПРИБОРОВ V1.5.1 - [РЕАЛИЗАЦИЯ USB TMC + ПАРСЕР SCPI]
</h1>
...
## ⚠️ Devices - адаптеры устройств на плате.
## ⚠️ Device_Class - пользовательские модули SCPI классов под адаптеры.

---

## ⚙️ [ Последующие версии ПО будут хранится на /PUBLIC ]
